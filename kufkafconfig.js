...
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "263719038262";
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "263780017273";


//========================= [ AUTO SAVE & READ STATUS ] =========================\\
global.read_status = process.env.AUTO_READ_STATUS || "true"
global.save_status = process.env.AUTO_SAVE_STATUS || "true"
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "263780017273,263781858423";
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "263780017273,263781858423";
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "Tebie",
  packname: process.env.PACK_NAME || "Tebie",
